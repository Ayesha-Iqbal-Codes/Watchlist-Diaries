...
import image1 from '../assets/hm.jpeg'; 
import image2 from '../assets/hm2.avif'; 
import image4 from '../assets/4I6r.gif';
...
const MovieModal = ({ movie, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-2">
      <div className="bg-gradient-to-b from-[#1a1a1a] to-[#4c0519] text-white p-3 sm:p-6 rounded-lg flex flex-col sm:flex-row w-full max-w-3xl h-auto">
        <img
          src={movie.image}
          alt={movie.title}
        ...
        <div className="flex flex-col justify-between w-full sm:w-1/2 text-xs sm:text-sm">
          <button
            onClick={onClose}
            className="self-end text-lg sm:text-xl font-bold mb-1 sm:mb-2"
          >
            X
          </button>
          ...
          <p className="mb-1 sm:mb-2">{movie.largeDescription}</p>
